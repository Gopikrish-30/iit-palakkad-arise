        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-sm text-green-800">
              <strong>Current Password:</strong> SecureAdminPassword123!<br />
              <strong>Security:</strong> Enterprise-grade authentication with JWT tokens, rate limiting, and audit logging.<br />
              <strong>Note:</strong> Change this password in production by updating ADMIN_PASSWORD in .env.local
            </p>
          </div>
        </CardContent>
      </Card>
