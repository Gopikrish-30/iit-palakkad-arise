...
import { Home, Users, BookOpen, Microscope, Award, GraduationCap, Eye, LogOut, Phone, Settings, Image, Calendar, UserCheck, Info, UserPlus } from "lucide-react"
        ...
        >
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            <TabsList className="grid w-full grid-cols-4 lg:grid-cols-11 gap-1">
              ...
              <TabsTrigger value="join-us" className="flex items-center gap-2">
