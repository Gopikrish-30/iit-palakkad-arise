...
import { ExternalLink, FileText, Quote, Calendar, Users, Download, LinkIcon, ArrowLeft, Globe } from "lucide-react"
...
export default function ResearchEventsPage() {
  ...
  const eventPublications = publications.filter(pub => pub.type === "event")
  const years = ["All", ...Array.from(new Set(eventPublications.map(pub => pub.year.toString()))).sort().reverse()]

  const filteredPublications = eventPublications.filter((pub) => {
  ...
  const generateCitation = (pub: any) => {
    ...
    return `${authorsStr}. (${pub.year}). ${pub.title}. Presented at ${venue}. DOI: ${pub.doi}`
  }
  ...
  const downloadCitation = (pub: any, format: string) => {
    ...
    if (format === "bibtex") {
      ...
      content = `@misc{${firstAuthorLastName}${pub.year},
  title={${pub.title}},
  author={${pub.authors.join(" and ")}},
  howpublished={Presented at ${pub.venue || pub.journal}},
  year={${pub.year}},
  doi={${pub.doi}}
}`
    ...
    <div ref={pageRef} className="min-h-screen bg-gray-50 pt-20">
      ...
      <section className="bg-gradient-to-r from-orange-600 to-orange-800 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          >
            <Link href="/research" className="inline-flex items-center text-orange-100 hover:text-white mb-4">
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                <h1 className="text-5xl font-bold">Research Events</h1>
                <p className="text-xl mt-2">
                  {eventPublications.length} presentations and workshops
                </p>
              </div>
            </div>
            <p className="text-lg max-w-3xl leading-relaxed">
              Explore our research presentations, workshops, and symposiums where we share 
              our work with the scientific community and engage in collaborative discussions.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          <Input
            placeholder="Search by title, author, event, or venue..."
            value={searchTerm}
            ...
            >
              <Card
                className={`hover:shadow-lg transition-all duration-300 ${
                  publication.featured ? "ring-2 ring-orange-200 bg-orange-50" : ""
                }`}
              >
                    ...
                    <div className="flex-1">
                      <div className="flex items-start gap-3 mb-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap items-center gap-2 mb-3">
                            <Badge className="bg-orange-600 text-white">Research Event</Badge>
                      ...
                      <div className="mb-3">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-sm font-medium text-gray-700">Presenters:</span>
                        </div>
        ...
        {filteredPublications.length === 0 && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-600 mb-2">No research events found</h3>
