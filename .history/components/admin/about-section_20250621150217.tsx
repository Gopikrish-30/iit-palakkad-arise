...
export default function AboutSection() {
  ...
  const updateItem = (type: 'timeline' | 'activities' | 'gallery', index: number, updates: any) => {
    setFormData(prev => ({
      ...prev,
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage the about page content, history, timeline, and activities</p>
        </div>
