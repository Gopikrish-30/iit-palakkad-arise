...
export default function AboutSection() {
  ...
  const addTimelineItem = () => {
    const newItem = {
      ...
      title: "New Lab Photo",
      description: "A detailed description of what this photo showcases in our research lab, including the activities, equipment, or achievements captured in this moment.",
            ...
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  Photo Gallery ({formData.timeline.length} photos)
                </div>
                {isEditing && (
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          disabled={!isEditing}
                          placeholder="e.g., 2024 or Research"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          disabled={!isEditing}
                          placeholder="e.g., Advanced Research Facility"
                        />
                      </div>
                      <div className="md:col-span-2">
                        ...
                        <Textarea
                          ...
                          disabled={!isEditing}
                          rows={4}
                          placeholder="Detailed description of what this photo showcases..."
                        />
                      </div>
                      <div className="md:col-span-2">
