...
const initialInstruments = [
  {
    ...
    specs: ["256 CPU cores", "2TB RAM", "100TB storage"],
    applications: ["Machine Learning", "Simulation", "Data Analysis"],
    details: "Our HPC cluster provides researchers with computational power for complex simulations.",
  },
]
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Instruments Management</h2>
