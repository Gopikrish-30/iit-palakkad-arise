                ...
                item.subItems ? (
                  <DropdownMenu key={item.name}>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="ghost"
                        className={`transition-colors hover:text-blue-600 font-medium flex items-center gap-1 ${
                    ...
                    <DropdownMenuContent align="start" className="w-48 bg-white border border-gray-200 shadow-lg">
                      {item.subItems.map((subItem) => (
                        <DropdownMenuItem key={subItem.name} asChild className="focus:bg-gray-50 hover:bg-gray-50">
                          <Link
                            href={subItem.href}
                            className={`w-full px-3 py-2 transition-colors hover:text-blue-600 ${
