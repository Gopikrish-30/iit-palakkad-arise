                  ...
                  <DropdownMenu key={item.name}>
                    ...
                    <DropdownMenuContent align="start" className="w-48 bg-white border border-gray-200 shadow-lg">
                      {item.subItems.map((subItem) => (
                        <DropdownMenuItem key={subItem.name} asChild className="focus:bg-gray-100 hover:bg-gray-100">
                          <Link
                            href={subItem.href}
                            className={`w-full px-3 py-2 transition-colors ${
                              pathname === subItem.href ? "text-blue-600 font-semibold bg-blue-50" : "text-gray-900"
                            }`}
                          >
                            {subItem.name}
                          </Link>
