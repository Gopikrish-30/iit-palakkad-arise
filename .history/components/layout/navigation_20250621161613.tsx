                ...
                item.subItems ? (
                  <DropdownMenu key={item.name}>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="ghost"
                        className={`transition-colors hover:bg-gray-100 font-medium flex items-center gap-1 ${
                    ...
                    <DropdownMenuContent align="start" className="w-48 bg-white border border-gray-200 shadow-lg">
                      {item.subItems.map((subItem) => (
                        <DropdownMenuItem key={subItem.name} asChild className="focus:bg-gray-100 hover:bg-gray-100 data-[highlighted]:bg-gray-100">
                          <Link
                            href={subItem.href}
                            className={`w-full px-3 py-2 transition-colors ${
                              pathname === subItem.href ? "text-blue-600 font-semibold" : "text-gray-900"
                            }`}
                          >
                            {subItem.name}
                          </Link>
                  ...
                  <Link
                    key={item.name}
                    href={item.href}
                    className={`transition-colors hover:bg-gray-100 px-3 py-2 rounded font-medium ${
