  ...
  timeline: [
    {
      ...
      description: "Founded with initial focus on machine learning and computer vision research.",
      image: "/placeholder.svg?height=200&width=300"
    },
    {
      year: "2016",
      title: "First Major Publication",
      description: "Published breakthrough research in IEEE Transactions on Pattern Analysis.",
      image: "/placeholder.svg?height=200&width=300"
    },
    {
      year: "2018",
      title: "Robotics Division",
      description: "Expanded research scope to include robotics and autonomous systems.",
      image: "/placeholder.svg?height=200&width=300"
    },
    {
      year: "2020",
      title: "Industry Partnerships",
      description: "Established collaborations with leading tech companies for applied research.",
      image: "/placeholder.svg?height=200&width=300"
    },
    {
      year: "2022",
      title: "International Recognition",
      description: "Received international awards for contributions to AI research.",
      image: "/placeholder.svg?height=200&width=300"
    },
    {
      year: "2024",
      title: "Expansion",
      description: "Opened new facilities and welcomed 50+ research scholars.",
      image: "/placeholder.svg?height=200&width=300"
    }
  ],
  activities: [
...
export function DataProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      const savedAboutContent = localStorage.getItem('lab-about-content')
      const savedJoinUsContent = localStorage.getItem('lab-join-us-content')
      ...
      if (savedJoinUsContent) setJoinUsContent(JSON.parse(savedJoinUsContent))
    }
  }, [])
